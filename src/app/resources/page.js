        ...
        <section id="getting-started">
          ...
          <div className="my-12 mx-24 flex gap-12 justify-start">
            <Link
              ...
              href={
                "https://1drv.ms/b/c/a1218d0c38262d8e/Ee7hF5LnFiZDjMfeUODJj3ABiJ8J1FNW_TuZfXUd3vxy4Q?e=sDVdy9"
              }
            ...
            <Link
              className="cursor-pointer rounded-xl bg-yellow-mid px-8 py-4 font-medium hover:bg-yellow-dark"
              href={
                "https://1drv.ms/b/c/a1218d0c38262d8e/EfLy1un-bL5Cky5C2oDTl0wBEUTOEE_dwA0Q2IPQIIZUpQ?e=hLXjeI"
              }
        ...
        <section id="toolkits">
          ...
          <div className="my-12 mx-24 flex gap-12 justify-start">
            <Link
              ...
              href={
                "https://1drv.ms/b/c/a1218d0c38262d8e/EV1_Sej4hXFOjthWtP3bWK0B-AL0OYV7By_w4hcsKVExxQ?e=PpHnx3"
              }
            >
            ...
            <Link
              ...
              // onClick={() => handleDownload('Rules_and_Regulations.pdf', 'Rules and Regulations.pdf')}
              href={
                "https://1drv.ms/b/c/a1218d0c38262d8e/EQnO7g_jRvdAo-6agqT3K_cBCAleoZ0x2kury82J9gk9Mg?e=RhneiD"
              }
            >
              Model Canvas
            </Link>
            <Link
              ...
              // onClick={() => handleDownload('Rules_and_Regulations.pdf', 'Rules and Regulations.pdf')}
              href={
                "https://1drv.ms/b/c/a1218d0c38262d8e/EaXMsc2cYFRCuYhtlajNKAcBES1LapPjY4oDEYXeoRjKTg?e=10U12h"
              }
            >
              Judging Criteria
            </Link>
        ...
        <section id="events">
          ...
          <div className="my-12 mx-24 flex gap-12 justify-start">
            <Link
              ...
              // onClick={() => handleDownload('Onboarding_Guide.pdf', 'Onboarding Guide.pdf')}
              href={
                "https://1drv.ms/b/c/a1218d0c38262d8e/ERh639TUg3pAgXOlcV8tdDgB3aZgUIiJ_Ou58ceXHQVdDg?e=2A16a1"
              }
            >
              Mentoring Session
            </Link>
            <Link
              className="cursor-pointer rounded-xl bg-yellow-mid px-8 py-4 font-medium hover:bg-yellow-dark"
              href={
                "https://1drv.ms/b/c/a1218d0c38262d8e/ETR_HRh-MM9Do7z7IP-SPmkBUt3FAzTQKms6j3cEbqOVpA?e=iP0bvy"
              }
              // onClick={() => handleDownload('Rules_and_Regulations.pdf', 'Rules and Regulations.pdf')}
            >
              Workshop Calendar
