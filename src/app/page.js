        ...
        <div className="w-full py-16 px-8 sm:px-18 md:px-48 flex flex-col gap-16">
          ...
          >
            <div className="text-white align-middle">
              ...
              <p className="py-2 text-lg font-medium leading-relaxed">
                BizMaker is an annual event organized by the Management Society,
                USM to provide students with a platform to improve the skills
                and expertise required in the business and entrepreneurship
                fields. Are you a novice in entrepreneurship?
              </p>
            </div>
            <Image
              src={asset1}
              alt="picture"
              className="object-contain w-140 h-45"
            />
          </section>

          <section
            id="challenge"
            className="align-center text-center justify-center"
          >
            ...
            <div className="mx-16 my-8 py-16 px-12 rounded-2xl bg-blue-light">
              <p className="font-semibold text-lg leading-relaxed">
                Participants are required to propose a revolutionary business
                idea with the integration of digital technology for Malaysian
                end consumers living in a post-pandemic era. Digital
                transformation is the integration of digital technology into all
                areas of a business, fundamentally changing how companies
                operate and deliver value to customers. Participants may choose
                to develop their digitally transformed business ideas in any of
                the three areas listed in the following.
              </p>
            </div>
          </section>
          ...
          >
            ...
            <div className="flex flex-col md:flex-row gap-16 mx-16 justify-center py-8">
              <div className="py-16 px-12 rounded-2xl bg-blue-mid">
                ...
                <p className="pt-4 font-bold text-xl md:text-2xl text-white">
                  Health and Wellness
                </p>
              </div>
              <div className="py-16 px-12 rounded-2xl bg-blue-mid">
                <h1 className="font-semibold text-lg">Track 2</h1>
                <p className="pt-4 font-bold text-2xl md:text-2xl text-white">
          ...
          >
            ...
            <div className="grid grid-rows-5 sm:grid-rows-10 grid-flow-col gap-4 mx-12 sm:mx-32 mt-8">
              <div className="row-start-2 text-grey text-2xl font-bold">
                <span className="text-md">RM</span> 1500
              </div>
              <div className="row-start-3 row-end-5 sm:row-end-11 bg-grey text-blue-dark p-4 font-bold text-2xl">
                Second Prize
              </div>
              <div className="row-start-1 text-yellow-mid text-2xl font-bold">
                <span className="text-md">RM</span> 3000
              </div>
              <div className="row-start-2 row-end-5 sm:row-end-11 bg-yellow-mid text-blue-dark p-4 font-bold text-2xl">
                Champion
              </div>
              <div className="row-start-3 text-[#FE864E] text-2xl font-bold">
                <span className="text-md">RM</span> 1000
              </div>
              <div className="row-start-4 row-end-5 sm:row-end-11 bg-[#FE864E] text-blue-dark p-4 font-bold text-2xl">
                Third Prize
              </div>
            </div>
          </section>
