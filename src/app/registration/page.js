...
function RegisterTeam({ control, generateCode, copyCode, teamType, setTeam, codeGenerated }) {
    return (
        <div className='max-w-4xl w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 shadow-input text-white'>
            ...
            {teamType === NEW_TEAM && (
                <>
                    <h2 className='font-bold text-xl text-yellow-dark mb-6'>Create a New Team</h2>
            ...
            {teamType === EXISTING_TEAM && (
                <>
                    <h2 className='font-bold text-xl text-blue-mid mb-6'>Join an Existing Team</h2>
                    <div className='grid grid-cols-1 gap-6 my-8'>
                        <div className='grid grid-cols-4 justify-between items-end gap-4'>
...
function ConfirmRegistration({ form }) {
    return (
        <div className='flex flex-col justify-center items-center text-white gap-6 pt-20'>
            ...
            <div>
                <p className='font-semibold text-lg'>Thank you for registering for BizMaker!</p>
            </div>
            <div>
...
export default function Registration() {
    ...
    const form = useForm({
        ...
        mode: "onChange",
        defaultValues: {
            first_name: "Dean Sheng Ting",
            last_name: "Lau",
            email: "ahdeanlau@gmail.com",
            phone: "0135883813",
            country: "Malaysia",
            university: "shit",
            password: "Qsm8896!",
            confirmPassword: "Qsm8896!",
            // password: "sdf",
            // confirmPassword: "sdf",
            team_name: "",
            team_code: "",
    ...
    return (
        <div className='font-[family-name:var(--font-geist-sans)]'>
            <TopBanner title='Registration' description='Each team can have up to 5 members' />
